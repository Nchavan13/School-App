package com.niltech.ShivajiSchool.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.niltech.ShivajiSchool..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.niltech.ShivajiSchool.*.*(..))",throwing = "ex")
